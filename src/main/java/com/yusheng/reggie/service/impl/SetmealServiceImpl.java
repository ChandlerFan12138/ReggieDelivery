...
public class SetmealServiceImpl extends ServiceImpl<SetmealMapper, Setmeal> implements SetmealService {
    ...
    public void removeWithDish(List<Long> ids) {
        ...
        //check the status of setmeal to make sure it is not sold any more
        ...
        if(count > 0){
            throw new CustomException("The setmeal is now saling, can not be deleted");
        }

        //if can be delete, delte the data in setmeal first.
        this.removeByIds(ids);

        //delete from setmeal_dish where setmeal_id in (1,2,3)
        LambdaQueryWrapper<SetmealDish> lambdaQueryWrapper = new LambdaQueryWrapper<>();
        lambdaQueryWrapper.in(SetmealDish::getSetmealId,ids);
        //delete the setmeal dish in---setmeal_dish
